...
The Mockdefinition is generated by the Designer. This allows the user to add, update or delete Scenarios.
...
The request match rules include [Header rules](./header-rules), [Query rules](./query-rules), [URL rules](./urlrules), and [Body rules](./body-rules).
