...
A mockdefinition is a JSON file that describes endpoints and the [scenarios](/docs/scenarios) that can be used to meet their criteria. The mockdefinition format that drives our platform is powerful and easy to learn. 
...
The mockdefinition is generated by the Orbital Designer. This allows the user to add, update or delete [scenarios](/docs/scenarios).
