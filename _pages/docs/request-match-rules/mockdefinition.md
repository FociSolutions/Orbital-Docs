...
The mockdefinition format that drives our platform is powerful and easy to learn. A mockdefinition is a JSON file that describes endpoints and the [scenarios](/docs/scenarios) that can be used to meet their criteria.
...
The mockdefinition is generated by the designer. This allows the user to add, update or delete [scenarios](/docs/scenarios).

Orbital Designer offers a simple import feature that allows you to import existing mockdefinitions from files:

![Mockdefinition Import From File](../../../assets/images/orbital-ui/mock-import-from-file.png)

Mockdefinitions could be preloaded on the Orbital Mock Server at startup from git repository or from the local file path and Orbital Designer has an option to import them for further use.

![Mockdefinition Import From Server](../../../assets/images/orbital-ui/mock-import-from-server.png)
